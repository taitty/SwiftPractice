//
//  UpComingTileCellController.swift
//  myMovieGuide
//
...
class UpComingTileCellController: ContentTileCellBase {
    ...
    override func configurationCell(on: UICollectionView, data: HomeScreenCategoryContent, indexPath: IndexPath) -> UICollectionViewCell {
        let cell = on.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! UpComingTileCell
